...
namespace cubecraft {
    Texture::Texture(std::string_view filename) {
        ...
        transitionImageLayoutFromUndefine_To_Dst();
        transformData_To_Image(*buffer, w, h);
        transitionImageLayoutFromDst_To_Optimal();
    ...
    void Texture::transitionImageLayoutFromUndefine_To_Dst() {
        Context::Instance().commandManager->ExecuteCmd(Context::Instance().graphicsQueue,
            [&](vk::CommandBuffer cmdBuf) {
